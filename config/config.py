...
API_ID = int(getenv("27512255") 

API_HASH = getenv("f9b0f252d558392419a90c2c7aced5bd")


## Get it from @Botfather in Telegram.
BOT_TOKEN = getenv("7553492462:AAH1eAPxZgGrqmMsa7zWmC240Kh4U9-K1y4")
...
UPSTREAM_REPO = getenv(
    "UPSTREAM_REPO",
    "https://github.com/ellrobot/DinoMusic.git",
)
...
SUPPORT_CHANNEL = getenv(
    "SUPPORT_CHANNEL", "dinomistik"
)  # Example:- https://t.me/AnonymousX888
SUPPORT_GROUP = getenv(
    "SUPPORT_GROUP", "Dino1Groupp"
...
GITHUB_REPO = getenv("GITHUB_REPO", "https://github.com/ellrobot/DinoMusic.git")
